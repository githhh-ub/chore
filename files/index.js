...
const UUID = process.env.UUID || '409c88f7-f315-4bde-add3-39d4b9144a56'; //若需要改UUID，需要在config.json里改为一致
...
const ARGO_DOMAIN = process.env.ARGO_DOMAIN || 'cchhroe.bacckg.us.kg';     // 建议使用token，argo端口8080，cf后台设置需对应,使用json需上传json和yml文件至files目录
